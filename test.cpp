...
//  * @LastEditTime: 2022-09-06 19:29:28
//  */
// #include <iostream>
// #include <string>
// #include <vector>
...
// //      Solution solver;
// //      cout <<
// solver.evalRPN({"10","6","9","3","+","-11","*","/","*","17","+","5","+"}) <<
// endl;
// //      return 0;
// // }
// // class MyQueue
...
// //     }
// //     // 回溯
// //     void backtrack(vector<int> &road, vector<int> &nums, vector<bool>
// &used)
// //     {
...
// //     }
// //     // 路径是bucket，选择是nums
// //     bool trackback(vector<int>& nums,int k,int target,int bucket,int
...
// //             used[i] = true;
// //             bucket += nums[i];
// //             if(trackback(nums,k,target,bucket,i+1,used))//
// 如果这条路径通了，直接返回true
// //                 return true;
...
// //             if (i > 0 && choice[i] == choice[i - 1] && used[i - 1] ==
// false) {
// //                 continue;
// //             }
// //             if(used[i])
...
// //             return true;
// //         else if(s.substr(j + 1, (3 - i))[0]!='0'&&s.substr(j + 1, (3 -
// i))<=string("255"))
// //             return true;
// //         else
// //             return false;
